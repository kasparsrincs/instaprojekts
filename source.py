...
bilde = r"C:\Users\Kaspars R\Documents\kakis\lauwa.jpg"
bildes_apraksts="Liels kakis"
...
pyautogui.write(bilde) 
time.sleep(2)
pyautogui.press('Enter')

time.sleep(2)

pele=driver.find_element(By.XPATH,"/html/body/div[6]/div[1]/div/div[3]/div/div/div/div/div/div/div/div[1]/div/div/div/div[3]/div/div")
pele.click()
time.sleep(1)
...
pele=driver.find_element(By.XPATH,"/html/body/div[6]/div[1]/div/div[3]/div/div/div/div/div/div/div/div[2]/div[2]/div/div/div/div[1]/div[2]/div/div[1]/div[1]")
pele.send_keys(bildes_apraksts)
time.sleep(1)
